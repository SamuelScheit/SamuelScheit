		...
		<Timeline>
			<TimelineItem date="November 2003" title="Life">
				<div>
					...
					<br />
					His father grew up in Konstanz, Germany, studied technical computer science, while his grandfather studied electrical
					engineering. <br />
					<br />
			...
			<TimelineItem date="October 2013" title="Lego Mindstorms">
				...
				/>
				<div>
					At the age of 10, Samuel was introduced to robotics through the construction and visual programming of a Lego Mindstorms
					robot, which sparked a passion for building projects.
					<br />
					<br />
			...
			<TimelineItem date="August 2014" title="Learning programming">
				<div>
					In addition to building with Lego, Samuel enjoyed playing video games, like many other children his age. However, he had
					to share the family computer with his{" "}
					<a rel="noreferrer" target="_blank" href="https://linktr.ee/GxdAim">
						brother
					</a>{" "}
					and parents. <br />
					<br />
					As a result, he asked his (grand)parents for a own computer and after negotiating they agreed to purchase one for him,
					if he learned programming first. <br />
					<br />
					Samuel learned the{" "}
					<a rel="noreferrer" target="_blank" href="https://www.c-howto.de/">
						C
					</a>{" "}
					programming language because it was the only language they could help him with. He used it to program a Sudoku solver,
					which he then used to help his grandfather solve sudokus in the newspaper.
				</div>
			</TimelineItem>
			<TimelineItem date="November 2015" title="A personal computer">
				<div>
					...
					Minecraft. <br />
					<br />
					Within the game, he preferred playing in creative mode, where he was able to create complex structures similar to logic
					gates using &quot;command blocks and redstone&quot;. <br />
					<br />
			...
			<TimelineItem date="February 2017" title="Web development">
				<div>
					Samuel wanted to create a website that provided an overview of his Minecraft servers, so he had to learn HTML and CSS.{" "}
					<br />
					<br />
